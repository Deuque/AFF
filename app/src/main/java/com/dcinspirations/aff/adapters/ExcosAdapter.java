...
public class ExcosAdapter extends RecyclerView.Adapter<ExcosAdapter.viewHolder> {
    ...
    private ExcosFragment f;

    public ExcosAdapter(Context context, List<ExcosModel> objectlist, ExcosFragment fragment) {
    ...
    public viewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view   = inflater.inflate(R.layout.excos_layout, parent, false);
...
//                price.setTextColor(context.getColor(R.color.aux5));
                ...
                this.delete.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("AffExcos").child(currentObject.getKey()).removeValue();
                        FirebaseStorage.getInstance().getReference().child("AffExcos").child(currentObject.getKey()).delete();
                        refreshEvents();
                    }
                });
            }
